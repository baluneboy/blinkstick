...
def demo_web():
    ...
    ws = websocket.WebSocketApp("ws://live.blinkstick.com:9292/hroke",
...
if __name__ == "__main__":
    DUR = 2.0
    for i in range(10):
	bstick.set_random_color(); time.sleep(DUR);
	bstick.turn_off()
    bstick.set_random_color()
    time.sleep(DUR)
    bstick.turn_off()
    #demo_set_get_block_info("REPLACE_WITH_DATE_NOW", "REPLACE_WITH_TIME_NOW")
